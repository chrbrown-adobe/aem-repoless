...
export default async function decorate(block) {
  ...
  const url = `https://author-p107109-e1000961.adobeaemcloud.com/graphql/execute.json/securbank/FAQListbyTag;tag=${firsttag};variation=${variationname}?ts=${cachebuster}`;
  const options = {};
